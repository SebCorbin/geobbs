...
Les modèles métier suivants sont les modèles que nous avons mis en place côté serveur. S'agissant d'un prototype, seul les modèles Check et User ont été nécessaire.
...
Voici le modèle de notre base de données tel qu'il est prévu dans le projet finale.
